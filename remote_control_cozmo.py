...
# Heavily modified code barrowed from anki.
# Added wlecome images and optimized for cozmo rocket leageue .   MITCHELL CUMMING
#
...
def face(robot: cozmo.robot.Robot):
    
        image = Image.open("welcometo.png")
        ...
        image = Image.open("rocketleague.png")
        image = image.resize(cozmo.oled_face.dimensions(), Image.NEAREST)
        image = cozmo.oled_face.convert_image_to_screen_data(image)
...
class RemoteControlCozmo:
    def score_one(robot: cozmo.robot.Robot):
        ...
        for nothing in range(seconds):
            self.display_oled_face_image(image, 1000.0)
            time.sleep(1.0)
    ...
    def __init__(self, coz):
        ...
        default_anims_for_keys = ["anim_pounce_success_01",  # 0
                                  "anim_pounce_success_02",  # 1
                                  "anim_pounce_success_03",  # 2
                                  "anim_speedtap_wingame_intensity02_01",  # 3
                                  "anim_speedtap_wingame_intensity02_02",  # 4
                                  "anim_speedtap_wingame_intensity02_03",  # 5
                                  "anim_speedtap_wingame_intensity02_04",  # 6
...
def handle_index_page():
    ...
    <html>
        ...
        <body style="background-color:blue;">
            <h1 style="colour:orange; font-size:16px">Rocket League Cozmos</h1>
            <table>
                <tr>
                    <td valign = top>
                    ...
                    <td valign=top>
                        ...
                        <b>Y</b> : Toggle BOOST!(use for shooting, cannot turn when activated): <button id="deviceGyroId" onClick=onDeviceGyroButtonClicked(this) style="font-size: 14px">Default</button><br>
